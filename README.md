...
The first step is to obtain authorization.  NextLead supports OAuth 1.0a and OAuth 2 however it is up to the administrator
...
See the [developer documentation](https://developer.NextLead.org).
